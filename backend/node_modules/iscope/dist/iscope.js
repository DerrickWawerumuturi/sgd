...
function applyScopes(scopes, f, args, context) {
  return scopes.reduce((func, [scope, value]) => () => scope(value, func, args, context), f)();
}
...
function _default() {
  ...
  if (Array.isArray(firstArg) && Array.isArray(firstArg[0]) && typeof firstArg[0][0] === 'function' && firstArg[0][0].__iscope) {
